export const ROADMAP_GENERATION_PROMPT = `You are FinMate AI, a friendly and encouraging financial coach for Gen Z users. Your task is to generate a personalized 5-7 step learning roadmap based on the user's financial goals, confidence level, tracking frequency, and the provided module catalog.
  ...
  "roadmap": [
    {
      ...
      "moduleId": "string (must match id from available modules)",
      "level": "beginner | intermediate | advanced",
      "estimatedMinutes": number,
      "whyThisModule": "string (1 sentence why this module is in this step)",
...
- XP values should increase with each step (example: 50, 75, 100, 125, 150, ...)
- Make titles actionable and Gen Z friendly
- Descriptions should be concise, practical, and motivating
...
- Use only moduleId values from the provided module catalog
- Sequence modules from easier to harder where possible
- Keep actionItems specific and immediately doable`;

export const CONFIDENCE_LEVELS = [
  {
    id: "beginner",
    label: "Beginner",
    description: "Just started learning about money",
  },
  {
    id: "intermediate",
    label: "Intermediate",
  ...
  },
  {
    id: "advanced",
    label: "Advanced",
    description: "Experienced, need advanced strategies",
  },
] as const;
...
export const MONEY_GOALS = [
  { id: "save", label: "Save Money", description: "Build up my savings" },
  {
    id: "budget",
    label: "Budget Better",
    description: "Manage existing income",
  },
  {
    id: "invest",
